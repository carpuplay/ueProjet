...
def generer_deplacements_posibles(plateau, position_pion, joueur):
    ...
    for i in range(len(deplacements)):
        ...
        if 0 <= x < 4 and 0 <= y < 4 and plateau[x][y] == 0:
            deplacements_posibles.append((x, y))
    
    return deplacements_posibles
...
def verifier_victoire(plateau, joueur):
    ...
    if joueur == 1:
        ...
        if pions_noirs < 2 or not peut_se_deplacer(plateau, joueur):
            print("return 1")
            return 1
    else:
        print("return 0")
    ...
    if mode == 1:
        ...
        while True:
            ...
            if deplacer_pion(plateau, deplacement[0], deplacement[1], joueur):
                ...
                if verifier_victoire(plateau, joueur) == False:
...
def test_verifierVictoire():
    ...
    assert verifier_victoire(plateau2, 2) == False, "Erreur 1"
    assert verifier_victoire(plateau1, 1) == False, "Erreur 2"
